...
if("FALSE" STREQUAL "TRUE")
  set(realsense_camera_SOURCE_PREFIX /home/stefano/Progetto_Drone/Odroid_ArCaRa/NapoDrone_ws/src/realsense/realsense_camera)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stefano/Progetto_Drone/Odroid_ArCaRa/NapoDrone_ws/install/${idir}'.  Ask the maintainer 'Rajvi Jingar <rajvi.jingar@intel.com>, Reagan Lopez <reagan.lopez@intel.com>, Mark Horn <mark.d.horn@intel.com>' to fix it.")
    endif()
